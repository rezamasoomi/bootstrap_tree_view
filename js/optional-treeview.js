/* =========================================================
 * optional-treeview.js v1.3.0
 * =========================================================
 * Copyright 2023 Reza Masoomi
 * Project URL : https://github.com/rezamasoomi/optional_tree_view
 * ========================================================= */
    ...
    */
    ...
    Tree.prototype.buildTree = function (nodes, level) {
        ...
        $.each(nodes, function addNodes(id, node) {
            ...
            // Add check / unchecked icon //rezamasoomi
            ...
            if (_this.options.showCheckbox) {
                ...
                if (node.nodes) {
                    if(_this.options.showCheckboxForMasters){
                        let classList = ['check-icon'];
                        if (node.state.checked) {
                            classList.push(_this.options.checkedIcon);
                        } else {
